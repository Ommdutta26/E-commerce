...
module.exports.checkoutSession = async (req, res) => {
  try {
    ...
    async function createNewCoupon(userId) {
      await Coupon.findOneAndDelete({ userId });  // ✅ fixed line
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      // success_url: `http://localhost:5173/purchase-success`, // Uncomment this line for production
      // cancel_url: `http://localhost:5173/cart`, // Uncomment this line for production    
...
module.exports.paymentSuccess = async (req, res) => {
  try {
    ...
    console.log("Error processing useful checkout", error);
